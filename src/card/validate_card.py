...
class Card:
    ...
    def validate_card(self):
        self.card_number = self.get_valid_input("Enter card number", "Будь ласка, введіть номер Вашої картки:", 16)
        self.password = self.get_valid_input("Enter password", "Будь ласка, введіть пароль:", 4)
